                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Nation:      ${rocketsdata[widget.rocketdatanum].country}',
                        style: GoogleFonts.poppins(
                          fontSize: 12,
                          fontWeight: FontWeight.w500,
                          color: Swhite,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Fuel Required:    ${rocketsdata[widget.rocketdatanum].rocketfirst.fuelamount.toString()} Tons',
                                          style: GoogleFonts.poppins(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w400,
                                            color: Swhite,
                                        ...
                                        Text(
                                          'Sec To Burn:    ${rocketsdata[widget.rocketdatanum].rocketfirst.burnsec.toString()} Sec',
                                          style: GoogleFonts.poppins(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w400,
                                            color: Swhite,
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Fuel Required:    ${rocketsdata[widget.rocketdatanum].rocketsecond.fuelamount.toString()} Tons',
                                          style: GoogleFonts.poppins(
                                            fontSize: 11,
                                            fontWeight: FontWeight.w400,
                                            color: Swhite,
                                        ...
                                        Text(
                                          'Sec To Burn:    ${rocketsdata[widget.rocketdatanum].rocketsecond.burnsec.toString()} Sec',
                                          style: GoogleFonts.poppins(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w400,
                                            color: Swhite,
                                ...
                                Text(
                                  'Weight:    ${rocketsdata[widget.rocketdatanum].rocketengine.thrust.toString()} Kg',
                                  style: GoogleFonts.poppins(
                                    fontSize: 12,
                                    fontWeight: FontWeight.w400,
                                    color: Swhite,
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: SizedBox(
            ...
            child: SvgPicture.network(
              'https://www.svgrepo.com/show/444913/arrow-back-solid.svg',
              color: Sorange,
            ),
          ),
        ),
